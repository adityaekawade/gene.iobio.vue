...
(function(ptree, $, undefined) {
  ...
  ptree.build = function(options) {
    ...
    var treemap = d3.tree().separation(function(a, b) {
      return a.parent === b.parent || a.data.hidden || b.data.hidden ? 0.1 : 0.1;
  ...
  ptree.get_tree_dimensions = function(opts) {
    ...
    var max_depth = Object.keys(generation).length*opts.symbol_size*2.5;
    var tree_width =  (svg_dimensions.width - opts.symbol_size > maxscore*opts.symbol_size*1.1 ?
      svg_dimensions.width - opts.symbol_size : maxscore*opts.symbol_size*1.1);
